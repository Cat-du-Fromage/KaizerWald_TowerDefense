...
namespace KWUtils
{
    ...
    public unsafe struct NativeCounter 
    {
        ...
        public const int INTS_PER_CACHE_LINE = CacheLineSize / sizeof(int);
        ...
        public NativeCounter(Allocator label) 
        {
            ...
            this.countIntegers = (int*) Malloc(SizeOf<int>() * INTS_PER_CACHE_LINE * MaxJobThreadCount, 4, label);
        ...
        public bool IsCreated => this.countIntegers != null;
...
#endif
            Free(this.countIntegers, this.m_AllocatorLabel);
